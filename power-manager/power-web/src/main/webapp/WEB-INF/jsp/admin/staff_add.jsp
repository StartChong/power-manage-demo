...
<form id="ff" class="easyui-form" method="post"  data-options="novalidate:true">
    <table cellpadding="5">
        ...
        <tr>
            ...
            <td>口令</td>
            <td><input class="easyui-passwordbox" prompt="Password" name="password" iconWidth="28" style="width:100%;height:34px;padding:10px"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>生日</td>
            <td><input class="easyui-datebox" name="birthday"></input></td>
        </tr>
        <tr>
            <td>性别</td>
            <td>
            ...
            <td>单位</td>
            <td><input class="easyui-textbox" type="text" name="station" data-options="required:true"></input></td>
        </tr>
        <tr>
            <td>联系电话</td>
        ...
        <tr>
            <td>备注</td>
            <td colspan="3"><input class="easyui-textbox" name="remark" data-options="multiline:true" style="height:60px"></input></td>
        </tr>
        <tr>
            <td>选择角色</td>
            <td colspan="3">
                <c:forEach items="${roleList}" var="role">
                    <input type="checkbox" name="roleIds" value="${role.role_id}">${role.name}
                </c:forEach>
            </td>
        </tr>
        <tr>
